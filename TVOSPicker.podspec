#
#  Be sure to run `pod spec lint TVOSPicker.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = "TVOSPicker"
  s.version      = "0.0.2"
  s.summary      = "A sweet horizontal picker view controller for tvOS."
...
- Otherwise, it would be presented modally over the presenting view controller. So, you should be careful when you call it over an already modally presented view controller. I recommend you to wrap it with a navigation controller if you tend to present a picker from a modally presented view controller.
  ...
  s.homepage     = "https://github.com/cemolcay/TVOSPicker"
  ...
  s.source       = { :git => "https://github.com/cemolcay/TVOSPicker.git", :tag => "#{s.version}" }
  ...
  s.source_files  = "TVOSPicker/TVOSPickerViewController.swift"
